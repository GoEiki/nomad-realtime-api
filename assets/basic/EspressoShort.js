    ...
    Flow: [
        {
            ...
            ToDo: {
                ...
                Data: {
                    ...
                    * 3:フィルターホルダーにコーヒー粉を詰めてください。（フィルターホルダーは黒い持ち手のある、金属製のフィルターがついた部品です。）（量は計量スプーンに山盛り一杯です。タンパーを使って軽く押し詰める必要があります。）確認が取れたらFunction Calling(3)を行ってください。
