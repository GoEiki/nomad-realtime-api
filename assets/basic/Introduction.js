            ...
            ToDo:{
                ...
                Data: {
                    ...
                    * 2:ゲストの職業を聞いてください。ゲストの職業を聞くことができたらFunction Calling(2)を行なってください。
                     例「〇〇さん、あなたの職業は何ですか。」
                    * 3:ゲストにエスプレッソを勧め、Function Calling(3)を行なってください。（ゲストが自分で淹れるということに疑問を持ったらあなたが全力でサポートすると言ってください）
                    ...
                    * 5: ゲストにイヤホンをつけてもらい、つけたことが確認できたらFunction Calling(5)を行ってください。このステップが終了すると次のタスクに移行します。
                     例「イヤホンをつけてください。」
                    {{footerinstructions}}`
                }
            },
