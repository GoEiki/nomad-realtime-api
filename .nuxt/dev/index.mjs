import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, getQuery as getQuery$1, readBody, defineWebSocketHandler, getResponseStatusText } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import wsAdapter from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/crossws/dist/adapters/node.mjs';
import { WebSocket } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/ws/wrapper.mjs';
import { defineStore, createPinia, setActivePinia } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/pinia/dist/pinia.mjs';
import { RealtimeClient } from 'file:///Users/tamiyaayumu/nomad-realtime-api/utils/lib/client.js';
import { isVNode, watch, version, unref } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/vue/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/devalue/index.js';
import destr from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/errx/dist/index.js';
import { hash } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/ohash/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/tamiyaayumu/nomad-realtime-api/node_modules/@unhead/shared/dist/index.mjs';
...
const _HfP0gNmDlR = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/tamiyaayumu/nomad-realtime-api";
...
const _lazy_PgVGcH = () => Promise.resolve().then(function () { return relay$1; });
const _lazy_wzYTbC = () => Promise.resolve().then(function () { return state; });
const _lazy_oWeQUo = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/relay', handler: _lazy_PgVGcH, lazy: true, middleware: false, method: undefined },
  { route: '/state', handler: _lazy_wzYTbC, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_oWeQUo, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_oWeQUo, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"/Users/tamiyaayumu/nomad-realtime-api/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/tamiyaayumu/nomad-realtime-api","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/tamiyaayumu/nomad-realtime-api/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/tamiyaayumu/nomad-realtime-api/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/tamiyaayumu/nomad-realtime-api/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/tamiyaayumu/nomad-realtime-api/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
class User {
  constructor(connection) {
    ...
    __publicField(this, "userpeers");
    __publicField(this, "consolepeers");
    __publicField(this, "CurrentClient");
    this.connection = connection;
    this.userpeers = this.createPeerProxy({}, "UserPeer");
    this.consolepeers = this.createPeerProxy({}, "ConsolePeer");
  ...
  //プロキシのセット
  createPeerProxy(peers, Proxyname = "") {
  ...
  //Userメンバーをメッセージ化
  StringfyStatus() {
    const UserPeer = Object.entries(this.userpeers).reduce((acc, [id, value]) => {
      acc[id] = value.name;
      return acc;
    }, {});
    const ConsolePeer = Object.entries(this.consolepeers).reduce((acc, [id, value]) => {
      acc[id] = value.name;
      return acc;
    }, {});
  ...
  SendToConsolePeers(message, forgetID) {
...
const relay = defineWebSocketHandler({
  open(peer) {
    ...
    if (!name) {
      ...
      if (role === "user") {
        ...
        name = "CONSOLE-" + generateRandomName();
      }
    }
...
const relay$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: relay
});

const RealtimeStore$1 = defineStore("messages", {
  state: () => ({
    realtimeEvents: [],
    // Realtime API のイベントを保存
    client: null,
    // Realtime API クライアント
    wavRecorder: null,
    // 録音インスタンス
    ...
    // 再生インスタンス
    clientCanvas: undefined,
    // クライアントの波形描画キャンバス
    serverCanvas: undefined,
    // サーバーの波形描画キャンバス
    isConnected: false,
    // Realtime API に接続状態
    isMuted: false,
    ...
    NomadEvents: [],
    // Nomadのイベント
    RelayStatus: { UserPeers: {}, ConsolePeers: {}, CurrentClient: null }
  }),
  actions: {
    toggleMute() {
...
const RealtimeStore = defineStore("messages", {
  state: () => ({
    realtimeEvents: [],
    // Realtime API のイベントを保存
    client: null,
...
const ConnectState = () => {
  ...
  function ConversationHandler() {
    ...
    client.on("realtime.event", (realtimeEvent) => {
      ...
      if ((lastEvent == null ? undefined : lastEvent.event.type) === realtimeEvent.event.type) {
      ...
      if (realtimeEvent.event.type === "nomad.event") {
        realtimestore.NomadEvents.push(realtimeEvent);
      }
    });
...
console.log("state server starting");
RealtimeStore$1();
const { connectConversation, disconnectConversation, setClient, ConversationHandler, NomadEventsHandler } = ConnectState();
setClient();
ConversationHandler();

const state = /*#__PURE__*/Object.freeze({
  __proto__: null
});
...
const getClientManifest = () => import('file:///Users/tamiyaayumu/nomad-realtime-api/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/tamiyaayumu/nomad-realtime-api/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
