declare global {
  const ConnectState: typeof import('../../server/utils/APIClientForStateServer')['ConnectState']
  const StateManager: typeof import('../../server/utils/StateManager')['StateManager']
...
export { ConnectState } from '../../server/utils/APIClientForStateServer';
export { StateManager } from '../../server/utils/StateManager';