...
const inputText = ref(''); // 入力フォームの値を保持するための ref
const options = ['As User', 'Instruction', 'TextOnly', 'Direct']; // オプションのリスト
const selectedOption = ref(options[0]); // 選択されたオプションを保持するための ref
